...
class CarInfoRVAdapter(var queryResult: ArrayList<illegalCarListBean>,
    ...
    fun removeItem(id: Int) {
        ...
        MainPresenter.DeleteQueryHistory(queryResult[id].carID)
    ...
    fun addItem(s: illegalCarListBean) {
        queryResult.add(s)
        MainPresenter.SaveQueryHistory(s)
    ...
    override fun onClick(p0: View?) {
        ...
        MainPresenter.queryillegal(queryResult[position].shortCarID, object : MainPresenter.queryCallback {
